...
return await axios.get<postData>(`/post/${id}`);
};

const editPost = async (data: postData, id: string | undefined) => {
...
const { mutate, isSuccess, isPending } = useMutation({
    mutationFn: (data : postData) => editPost(data,id)
});
...
return (
    ...
    <FormPost isEdit={true} mutateFn={mutate} defaultInputData={getPostData.data?.data}/>
    </div>
    );
}
